    ...
    return (
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto font-body">
            ...
            <section aria-labelledby="experts" className="w-full mb-16">
                <h2 id="experts" className="font-display text-4xl lg:text-5xl mb-6">
                    What experts say
                </h2>
            ...
            <section aria-labelledby="mental-health" className="w-full mb-16">
                <h2 id="mental-health" className="font-display text-4xl lg:text-5xl mb-6">
                ...
                <h3 className="font-bold text-lg mb-3 text-(--muted)">
            ...
            <section aria-labelledby="brain" className="w-full mb-16">
                <h2 id="brain" className="font-display text-4xl lg:text-5xl mb-6">
            ...
            <section aria-labelledby="kids-sources" className="w-full mb-8 text-sm text-(--muted)">
                <h2 id="kids-sources" className="font-bold text-base mb-3 text-(--muted)">Sources</h2>
                <p>
