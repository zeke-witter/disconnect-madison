...
export default async function EventDetailPage({ params }: Props) {
    ...
    return (
        <div className="flex flex-col w-full max-w-3xl mx-auto font-[family-name:var(--font-space-grotesk)]">
            ...
            <div className="mb-2">
                <Link href="/events" className="text-sm text-(--secondary-accent) hover:text-(--primary-color) no-underline">
                    &larr; All events
                </Link>
            </div>
            ...
            <div className="flex flex-col gap-2 mb-8 text-(--secondary-accent)">
                ...
                {event.registration_required && (
                    <div className="flex items-start gap-2">
                        ...
                        <span className="font-semibold text-(--primary-accent)">Registration required</span>
                    </div>
                )}
                {event.capacity != null && (
                    <div className="flex items-start gap-2">
            ...
            <div className="mt-12 pt-8 border-t border-(--secondary-accent)/20">
                <Link href="/events" className="text-sm text-(--secondary-accent) hover:text-(--foreground) transition-colors">
