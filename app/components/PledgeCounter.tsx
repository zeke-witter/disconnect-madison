...
export default async function PledgeCounter() {
    ...
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center w-full font-display gap-6 lg:gap-0">
            <div className="text-center mx-8 max-w-70">
                <p className="text-6xl text-(--accent-muted)" aria-labelledby="pledged-to-reduce">{counts.reduce_screen_time.toLocaleString()}</p>
