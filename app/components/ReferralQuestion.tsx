            ...
            {selected === 'other' && (
                <div className="mt-4 flex gap-2 justify-center">
                    <input
                        ...
                        maxLength={200}
                        className="rounded-md border border-(--accent-muted) bg-transparent px-3 py-2 text-sm focus:outline-none focus:border-(--accent) w-56"
                    />
                    <button
                        onClick={handleOtherSubmit}
                        className="px-4 py-2 rounded-md bg-(--accent) hover:bg-(--accent-hover) text-(--on-accent) text-sm font-semibold transition-colors cursor-pointer"
                    >
                        Submit
                    </button>
                </div>
