...
export const metadata: Metadata = {
    title: "About",
    description: "Learn about Disconnect Madison's mission to help people step back from algorithm-driven social media and reconnect with real life in Madison, WI.",
        ...
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto font-[family-name:var(--font-space-grotesk)]">
            ...
            <section aria-labelledby="who" className="w-full mb-12">
                ...
                <div>
                    ...
                    />
                    <p className="mb-4">
                        Disconnect Madison was founded by one person. It is not funded by investors. It is not a political organization. It is not affiliated with any technology company or competitor. It is not selling a product.
                    </p>
                    <p className="mb-4">
